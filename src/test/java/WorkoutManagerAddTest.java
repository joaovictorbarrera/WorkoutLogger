...
public class WorkoutManagerAddTest {
    ...
    public void addWorkout_ShouldFail_WhenNameIsNull() {
        ...
        OperationResult<Workout> addResult = workoutManager.addWorkout(workout);
    ...
    public void addWorkout_ShouldAllowDuplicates() {
        Workout workout1 = new Workout(null, "Test", LocalDateTime.parse("2025-10-10T12:00"), 10, 10.0, UnitType.KILOMETERS, "");
        Workout workout2 = new Workout(null, "Test", LocalDateTime.parse("2025-10-10T12:00"), 10, 10.0, UnitType.KILOMETERS, "");
