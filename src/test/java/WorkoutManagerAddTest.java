...
public class WorkoutManagerAddTest {
    ...
    public void addWorkout_ShouldFail_WhenNameIsNull() {
        ...
        assertTrue(workoutManager.getAllWorkouts().getData().isEmpty());
    }
    ...
    public void addWorkout_DataNotCorrupted() {
        ...
        assertTrue(addResult.isSuccess());
        assertEquals(1, workoutManager.getAllWorkouts().getData().size());
        Workout addedWorkout = workoutManager.getAllWorkouts().getData().get(0);
    ...
    public void addWorkout_MultipleWorkouts() {
        ...
        assertEquals(3, workoutManager.getAllWorkouts().getData().size());
        assertEquals("Test1", workoutManager.getAllWorkouts().getData().get(0).getName());
        assertEquals("Test2", workoutManager.getAllWorkouts().getData().get(1).getName());
        assertEquals("Test3", workoutManager.getAllWorkouts().getData().get(2).getName());
    }
    ...
    public void addWorkout_DataIntegrity() {
        ...
        Workout workout2 = new Workout(null, "Test2", LocalDateTime.parse("2025-10-10T12:00"), 10, 10.0, UnitType.KILOMETERS, "");
        workoutManager.addWorkout(workout2);
        assertEquals(2, workoutManager.getAllWorkouts().getData().size());
        Workout workoutAtFirstIndex = workoutManager.getAllWorkouts().getData().get(0);
    ...
    public void addWorkout_ShouldAllowDuplicates() {
        ...
        workoutManager.addWorkout(workout);
        List<Workout> all = workoutManager.getAllWorkouts().getData();
    ...
    public void addWorkout_ShouldAssignUniqueIDs() {
        ...
        int id1 = workoutManager.getAllWorkouts().getData().get(0).getID();
        int id2 = workoutManager.getAllWorkouts().getData().get(1).getID();
